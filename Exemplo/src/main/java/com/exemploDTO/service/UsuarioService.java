...
public class UsuarioService {
	...
	public UsuarioDTO salvar (UsuarioDTO usuarioDTO) {
		...
		return new UsuarioDTO(salvarUsuario.getId(), salvarUsuario.getNome(), 
				salvarUsuario.getSenha());
	}
	 public UsuarioDTO atualizar(Long id,UsuarioDTO usuarioDTO) {
		 Usuario existeUsuario = usuarioRepository.findById(id).orElseThrow(() -> new 
				 ...
				 existeUsuario.setNome(usuarioDTO.nome());
		 		 ...
		 		 return new UsuarioDTO (updateUsuario.getId(), updateUsuario.getNome(),
		 				 updateUsuario.getSenha());
